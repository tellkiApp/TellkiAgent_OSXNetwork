...
var metrics = [];
metrics['Ipkts'] =  { retrieveMetric: 1, id: '1647:Network Packets In:4',           ratio: 2, get: function(t){return t[4];} }; // Ratio: 1=MB/s, 2=Count/s
metrics['Ierrs'] =  { retrieveMetric: 1, id: '1649:Network Errors In:4',            ratio: 2, get: function(t){return t[5];} };
metrics['Ibytes'] = { retrieveMetric: 1, id: '1645:Network Traffic In/sec:4',       ratio: 1, get: function(t){return t[6];} };
metrics['Opkts'] =  { retrieveMetric: 1, id: '1648:Network Packets Out:4',          ratio: 2, get: function(t){return t[7];} };
metrics['Oerrs'] =  { retrieveMetric: 1, id: '1650:Network Errors Out:4',           ratio: 2, get: function(t){return t[8];} };
metrics['Obytes'] = { retrieveMetric: 1, id: '1646:Network Traffic Out/sec:4',      ratio: 1, get: function(t){return t[9];} };
metrics['Coll'] =   { retrieveMetric: 1, id: '1651:Network Collisions:4',           ratio: 2, get: function(t){return t[10];} };
metrics['Drop'] =   { retrieveMetric: 1, id: '1652:Network Drops:4',                ratio: 2, get: function(t){return t[11];} };
